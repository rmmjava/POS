...
<?php include('include/headerSales.php'); ?>
            ...
            <div class="col-lg-12">
                <div class="row">
					<div class="col-lg-7">
						...
						<form action="sales/additemSales.php" method="post" >
		...
		<div class="col-lg-4">
						<div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
								...
								<button type="button" class="btn btn-default btn-lg" accesskey="F7" data-toggle="modal" data-target="#cash" ><i class="fa fa-money"></i> Cash</button>
