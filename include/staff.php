                                ...
                                <div class="modal-body">
                                    <div class="table-responsive">
                                      <table class="table table-hover">
                                            ...
                                            <td><input type="text" class="form-control" style="width:265px; height:30px;" name="empID"></td>
                                            </tr>
                      <tr>
                ...
                <div class="modal-body">
                  <table class="table table-hover">
                   <?php
                     ...
                     <input type="hidden" class="form-control"  name="empID" value="<?=$sn?>">
                  ...
                  <input type="submit" class="btn btn-block btn-success"  name ="UPDATE" value = "Save"><i class="" aria-hidden="true"></i>
                                    ...
                                    <?php $getRes = mysql_query("SELECT * FROM staff order by Staff_ID") or die(mysql_error());
                                    $ctr=0;
                                    $content="";
                                    while ($row = mysql_fetch_assoc($getRes)) {
...
<script id="template" type="text/html">
  <tr id='pen{{record.transID}}'>
    ...
    <td>
      <a  href ="staff.php?edit={{record.sn}}" title ="Edit" type="button" class="btn btn-xs btn-info" data-toggle="modal"><i class="fa fa-pencil-square" aria-hidden="true" ></i></a>
      <a title = "Delete"type="button" class="btn btn-xs btn-danger" onClick="confirm('do you really want this')"><i class="fa fa-trash-o" aria-hidden="true" ></i></a>
